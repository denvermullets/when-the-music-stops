module ApplicationHelper
  ...
  def embed_links(text)
    ...
    # sanitize again in case of unexpected HTML injection
    sanitize(embed_url(sanitized_text), tags: %w[iframe img a br div], attributes: %w[src href width height frameborder allow allowfullscreen style class seamless id data-ballot-id])
  end
